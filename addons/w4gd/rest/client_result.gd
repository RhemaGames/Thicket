...
## Returns true if the request was cancelled by user code; otherwise, false.
func is_cancelled() -> bool:
	return result_status == ResultStatus.CANCELLED


## Returns true if the response is an HTTP error (4xx or 5xx); otherwise, false.
func is_http_error() -> bool:
	return http_status_code >= 400 and http_status_code < 600
...
## Returns true if the HTTP status code is a 4xx; otherwise, false.
func is_http_client_error() -> bool:
	return http_status_code >= 400 and http_status_code < 500


## Returns true if the HTTP status code is a 5xx; otherwise, false.
func is_http_server_error() -> bool:
...
## Returns true if the request failed due to a network error; otherwise, false.
func is_network_error() -> bool:
	return result_status == ResultStatus.ERROR and http_status_code == 0
